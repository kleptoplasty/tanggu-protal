<template>
  <div
    :class="`bg-white shadow-regal-xl rounded-4xl border-regal-black-300 border-[0.5px] self-center mt-4 max-w-moblie-w p-[3.5px] xl:mt-14 xl:border-[1px] xl:max-w-[1032px] mx-auto`"
  >
